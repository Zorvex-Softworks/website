...
export default function TOS() {
  ...
  return (
    <main
      className={
        "overflow-x-hidden h-[100vh]" + (noBg ? " bg-black" : "")
      }
    >
      <DotPattern
        width={20}
        ...
        cr={1}
        className={cn(
          "[mask-image:linear-gradient(to_bottom_right,white,transparent,transparent)] -z-50 opacity-50" +
            (noBg ? " hidden" : "")
        )}
      />
      ...
      <div className="flex flex-col items-center justify-center ml-5 mr-5 py-10 md:py-20 px-4 md:px-20">
        ...
        <BlurFade delay={0.4 + 1 * 0.05} className="mb-5 mt-2">
          <p className="text-center">
            By purchasing, accessing, or using any mspaint products or services
            (&quot;Services&quot;), you acknowledge that you have read,
            understood, and agree to be bound by these Terms of Service.
            Violation of these terms may result in{" "}
            <strong>immediate termination of access</strong> and{" "}
            <strong>permanent exclusion</strong> from all mspaint products.
          </p>

          <div className="bg-blue-900/30 border border-blue-500/50 rounded-md p-3 my-4">
            <p className="text-center text-sm">
              <strong>Important Note:</strong> These Terms of Service apply
              exclusively to the current closed-source version of mspaint
              products. The previous open-source version, which was released
              under the MIT License, remains governed by that license.
            </p>
          </div>

          <h2 className="text-2xl font-bold flex flex-col mt-6">
            <strong>Usage and Distribution</strong>
          </h2>
          ...
          <h2 className="text-2xl font-bold flex flex-col mt-6">
            <strong>Intellectual Property and Security</strong>
          </h2>
          <div className="flex flex-col *:ml-5">
            ...
            <p>- <strong>Content Rights</strong>: Unless explicitly stated otherwise, you retain rights to content you create using mspaint products.</p>
          </div>
          ...
          <p className="text-center font-semibold mt-7 text-red-400">
            Violation of any of these terms will result in immediate termination
            of access to all current and future mspaint products and may subject
            you to legal action.
          </p>
